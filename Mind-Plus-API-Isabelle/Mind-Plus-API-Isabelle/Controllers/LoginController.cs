...
namespace Mind_Plus_API_Isabelle.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        [HttpPost]
        //[Route("login")] não necessário
        public async Task<IActionResult> Login(EmployeesLoginDTO employee) //Falta criar as pastas respectivas e transferir informações
        {
            try
            {
                return Ok(await _loginRepository.Login(employee));
            }
            catch (Exception ex)
            {
